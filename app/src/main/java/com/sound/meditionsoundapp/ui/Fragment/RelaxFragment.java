...
public class RelaxFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        DashboardView = inflater.inflate(R.layout.fragment_relax, container, false);
    ...
    private void initActions() {
        ...
        itemModelArrayList.add(itemModel);
        itemModel = new ItemModel(getString(R.string.hope_of_better), R.drawable.ic_hope_better);
        itemModelArrayList.add(itemModel);
            itemModel = new ItemModel(getString(R.string.look_within), R.drawable.ic_look_within);
        itemModelArrayList.add(itemModel);

        RvDashboard.setLayoutManager(new GridLayoutManager(context,2,RecyclerView.VERTICAL,false));
